            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div class="d-flex flex-column gap-1">
                        <h1 class="mb-0 h2 fw-bold">Edit Jenis Layanan</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ url('dashboard') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Jenis Layanan</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                ...
                <div class="offset-xl-3 col-xl-6 col-md-12 col-12">
                    <div class="card">
                        <div class="card-body p-lg-6">
                            <form action="{{ route('jenis-layanan.update', $jenisLayanan) }}" method="POST"
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <input type="text" name="nama_layanan" class="form-control"
                                        value="{{ $jenisLayanan->nama_layanan }}" placeholder="Masukkan nama layanan"
                                        required />
                                    <div class="invalid-feedback">Silakan masukkan nama layanan.</div>
                                </div>
                                <div class="mb-3 col-12">
                                    <label class="form-label">Deskripsi</label>
                                    <textarea name="deskripsi" class="form-control" placeholder="Masukkan deskripsi layanan..." rows="3" required>{{ $jenisLayanan->deskripsi }}</textarea>
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_active" id="active"
                                                value="1" {{ $jenisLayanan->is_active ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_active" id="inactive"
                                                value="0" {{ !$jenisLayanan->is_active ? 'checked' : '' }} required>
